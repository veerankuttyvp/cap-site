...
class User {
    ...
    /**
    * @var CAP\Entity\Language
    *
    * @ORM\ManyToOne(targetEntity="CAP\Entity\Language")
    ...
    *   "target_class":"CAP\Entity\Language",
    *   "property": "name"
    * })
    */
    protected $language;
    ...
    /**
     * @var CAP\Entity\State
     *
     * @ORM\ManyToOne(targetEntity="CAP\Entity\State")
     ...
     *   "target_class":"CAP\Entity\Question",
     *   "property": "question"
     * })
     */
    protected $question;
